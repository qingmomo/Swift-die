...
//            NSLog(@"chineseString.string== %@",chineseString.string);
            ...
            if(![chineseString.string isEqualToString:@""]){
                ...
                if ([chineseString.string compare:@"长沙"] == NSOrderedSame)
                {
                    chineseString.pinYin=@"CS";
                }
                if ([chineseString.string compare:@"厦门"] == NSOrderedSame)
                {
                    chineseString.pinYin=@"XM";
                }
                if ([chineseString.string compare:@"沈阳"] == NSOrderedSame)
                {
                    chineseString.pinYin=@"SY";
                }
                if ([chineseString.string compare:@"重庆"] == NSOrderedSame)
                {
                    chineseString.pinYin=@"CQ";
                }
            }else{
